            ...
            <div class="row carousel-wrap-row">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide bg-danger" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner h-100 w-100">
                            <div class="carousel-item active h-100">
                                ...
                                <img src="img/{{ $posts[0]->image }}" class="d-block w-100 h-100" alt="...">
                                <div class="carousel-caption">
                                    <a class="badge" href="">{{ $posts[0]->category->name }}</a>
                                    <h5>{{ $posts[0]->title }}</h5>
                                    <span class="card-text mb-0 fw-bold fs-8">{{ $posts[0]->user->username }}</span><span class="fs-8"> - 7 July 2023</span>
                            ...
                            <div class="carousel-item h-100">
                                <a class="cover-link" href="https://google.com" target="_blank"></a>
                                <img src="img/{{ $post->image }}" class="d-block w-100 h-100" alt="...">
                                <div class="carousel-caption">
                                    <a class="badge" href="">{{ $post->category->name }}</a>
                                    <h5>{{ $post->title }}</h5>
                                    <span class="card-text mb-0 fw-bold fs-8">{{ $post->user->username }}</span><span class="fs-8"> - 7 July 2023</span>
                                    <!-- <p>Some representative placeholder content for the first slide.</p> -->
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="col-md-4 d-flex flex-wrap main">
                    ...
                    <div class="card text-bg-dark img-card mb-1">
                        <a class="cover-link" href="https://google.com" target="_blank"></a>
                        <img src="img/{{ $post->image }}" class="card-img" alt="...">
            ...
            <div class="row">
                <div class="col-lg-8 d-flex justify-content-start flex-wrap side-main">
                        ...
                        <div class="cards mt-2 card-main" style="width: 20rem">
                            <a class="cover-link" href="https://google.com" target="_blank"></a>
                            <img src="img/{{ $berita->image }}" class="card-img-top" alt="...">
                            <div class="card-body">
                                <a href="https://youtube.com" class="badge" target="_blank">{{ $berita->category->name }}</a>
                                <h5 class="mb-0">{{ $berita->title }}</h5>
                                <span class="card-text mb-0 fw-bold fs-8">{{ $berita->user->username }}</span><span class="fs-8"> - 7 July 2023</span>
                        ...
                        <div class="content ms-4 mt-2">
                            ...
                            <div class="cards mb-3 d-flex justify-content-between align-items-center" style="max-width: 330px; flex-wrap: nowrap;">
                                <a class="cover-link" href="https://google.com" target="_blank"></a>
                                    <img src="img/{{ $post->image }}" class="img-fluid rounded w-100 h-100" alt="...">
